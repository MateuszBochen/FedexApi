...
class CustomsClearanceDetail
{
     ...
     */
    public function __construct(array $Brokers, $ClearanceBrokerage, $CustomsOptions, $ImporterOfRecord, $RecipientCustomsId, $DutiesPayment, $DocumentContent, $CustomsValue, $FreightOnValue, $InsuranceCharges, $PartiesToTransactionAreRelated, $CommercialInvoice, array $Commodities, $ExportDetail, array $RegulatoryControls, $DeclarationStatementDetail)
    {
    ...
    /**
     * @param BrokerDetail[] $Brokers
     * @return \FedexApi\Lib\CustomsClearanceDetail
     */
