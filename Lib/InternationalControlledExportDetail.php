...
class InternationalControlledExportDetail
{
     ...
     */
    public function __construct($Type, $ForeignTradeZoneCode, $EntryNumber, $LicenseOrPermitNumber, $LicenseOrPermitExpirationDate)
    {
      $this->Type = $Type;
    ...
    /**
     * @param InternationalControlledExportType $Type
     * @return \FedexApi\Lib\InternationalControlledExportDetail
     */
