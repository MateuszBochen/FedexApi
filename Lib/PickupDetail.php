...
class PickupDetail
{
     ...
     */
    public function __construct(\DateTime $ReadyDateTime = null, \DateTime $LatestPickupDateTime = null, $CourierInstructions = null, $RequestType = null, $RequestSource = null)
    {
      $this->ReadyDateTime = $ReadyDateTime ? $ReadyDateTime->format(\DateTime::ATOM) : null;
      $this->LatestPickupDateTime = $LatestPickupDateTime ? $LatestPickupDateTime->format(\DateTime::ATOM) : null;
