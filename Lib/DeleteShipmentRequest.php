...
class DeleteShipmentRequest
{
     ...
     */
    public function __construct($WebAuthenticationDetail, $ClientDetail, $TransactionDetail, $Version, \DateTime $ShipTimestamp, $TrackingId, $DeletionControl)
    {
    ...
    /**
     * @param WebAuthenticationDetail $WebAuthenticationDetail
     * @return \FedexApi\Lib\DeleteShipmentRequest
     */
