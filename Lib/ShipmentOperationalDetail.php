...
class ShipmentOperationalDetail
{
     ...
     * @param string $Scac
     */
    public function __construct($UrsaPrefixCode, $UrsaSuffixCode, $OriginLocationId, $OriginLocationNumber, $OriginServiceArea, $DestinationLocationId, $DestinationLocationNumber, $DestinationServiceArea, $DestinationLocationStateOrProvinceCode, $DeliveryDate, $DeliveryDay, $PublishedDeliveryTime, $CommitDate, $CommitDay, $TransitTime, $MaximumTransitTime, $CustomTransitTime, $IneligibleForMoneyBackGuarantee, array $DeliveryEligibilities, $AstraPlannedServiceLevel, $AstraDescription, $PostalCode, $StateOrProvinceCode, $CountryCode, $AirportId, $ServiceCode, $PackagingCode, $Scac)
    {
    ...
    /**
     * @param string $UrsaPrefixCode
     * @return \FedexApi\Lib\ShipmentOperationalDetail
     */
