...
class CodDetail
{
     ...
     */
    public function __construct($CodCollectionAmount, $AddTransportationChargesDetail, $CollectionType, $CodRecipient, $FinancialInstitutionContactAndAddress, $RemitToName, $ReferenceIndicator, $ReturnTrackingId)
    {
