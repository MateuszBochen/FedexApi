...
class ShipmentLegRateDetail
{
     ...
     */
    public function __construct($LegDescription, $LegOrigin, $LegOriginLocationId, $LegDestination, $LegDestinationLocationId, $RateType, $RateScale, $RateZone, $PricingCode, $RatedWeightMethod, $MinimumChargeType, $CurrencyExchangeRate, array $SpecialRatingApplied, $DimDivisor, $DimDivisorType, $FuelSurchargePercent, $TotalBillingWeight, $TotalDimWeight, $TotalBaseCharge, $TotalFreightDiscounts, $TotalNetFreight, $TotalSurcharges, $TotalNetFedExCharge, $TotalTaxes, $TotalNetCharge, $TotalRebates, $TotalDutiesAndTaxes, $TotalNetChargeWithDutiesAndTaxes, $FreightRateDetail, array $FreightDiscounts, array $Rebates, array $Surcharges, array $Taxes, array $DutiesAndTaxes, $VariableHandlingCharges, $TotalVariableHandlingCharges)
    {
    ...
    /**
     * @param string $LegDescription
     * @return \FedexApi\Lib\ShipmentLegRateDetail
     */
