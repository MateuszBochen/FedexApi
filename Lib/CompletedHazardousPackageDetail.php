...
class CompletedHazardousPackageDetail
{
     ...
     */
    public function __construct($ReferenceId, $Accessibility, $CargoAircraftOnly, $Regulation, $RadioactiveTransportIndex, $LabelType, array $Containers)
    {
    ...
    /**
     * @param string $ReferenceId
     * @return \FedexApi\Lib\CompletedHazardousPackageDetail
     */
