...
class ShipmentRateDetail
{
     ...
     */
    public function __construct($RateType, $RateScale, $RateZone, $PricingCode, $RatedWeightMethod, $MinimumChargeType, $CurrencyExchangeRate, array $SpecialRatingApplied, $DimDivisor, $DimDivisorType, $FuelSurchargePercent, $TotalBillingWeight, $TotalDimWeight, $TotalBaseCharge, $TotalFreightDiscounts, $TotalNetFreight, $TotalSurcharges, $TotalNetFedExCharge, $TotalTaxes, $TotalNetCharge, $TotalRebates, $TotalDutiesAndTaxes, $TotalNetChargeWithDutiesAndTaxes, array $ShipmentLegRateDetails, $FreightRateDetail, array $FreightDiscounts, array $Rebates, array $Surcharges, array $Taxes, array $DutiesAndTaxes, $VariableHandlingCharges, $TotalVariableHandlingCharges)
    {
    ...
    /**
     * @param ReturnedRateType $RateType
     * @return \FedexApi\Lib\ShipmentRateDetail
     */
