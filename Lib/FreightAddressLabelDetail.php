...
class FreightAddressLabelDetail
{
     ...
     */
    public function __construct($Format, $Copies, $StartingPosition, $DocTabContent, $CustomContentPosition, $CustomContent)
    {
      $this->Format = $Format;
      $this->Copies = $Copies;
    ...
    /**
     * @param ShippingDocumentFormat $Format
     * @return \FedexApi\Lib\FreightAddressLabelDetail
     */
