...
class FreightShipmentDetail
{
     ...
     */
    public function __construct($FedExFreightAccountNumber, $FedExFreightBillingContactAndAddress, $AlternateBilling, array $PrintedReferences, $Role, $CollectTermsType, $DeclaredValuePerUnit, $DeclaredValueUnits, $LiabilityCoverageDetail, array $Coupons, $TotalHandlingUnits, $ClientDiscountPercent, $PalletWeight, $ShipmentDimensions, $Comment, array $SpecialServicePayments, $HazardousMaterialsEmergencyContactNumber, $HazardousMaterialsOfferor, array $LineItems)
    {
    ...
    /**
     * @param string $FedExFreightAccountNumber
     * @return \FedexApi\Lib\FreightShipmentDetail
     */
