...
class ShippingDocumentSpecification
{
     ...
     */
    public function __construct(array $ShippingDocumentTypes, $CertificateOfOrigin, $CommercialInvoiceDetail, array $CustomPackageDocumentDetail, array $CustomShipmentDocumentDetail, $ExportDeclarationDetail, $GeneralAgencyAgreementDetail, $NaftaCertificateOfOriginDetail, $Op900Detail, $DangerousGoodsShippersDeclarationDetail, $FreightAddressLabelDetail, $ReturnInstructionsDetail)
    {
    ...
    /**
     * @param RequestedShippingDocumentType[] $ShippingDocumentTypes
     * @return \FedexApi\Lib\ShippingDocumentSpecification
     */
